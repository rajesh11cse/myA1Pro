...
class Landing extends React.Component {
    ...
    componentDidMount(){
        ...
        localStorage.setItem('personal_answers', {});
    }
                        ...
                        <div className="item active slide_1">
                          ...
                          <div className="container-fluid">
                            <div className="carousel-caption">
                              {/*<h1>GigUp!</h1>
                              <p>a flexible job that allows you to set your own<br></br>schedule for on-demand tasks</p>
                              <Link className="gig_button background backgroundHover color_1" to="/Questionnaire">GO GIG IT!</Link>*/}
                            </div>
                          </div>
                        </div> 
                      ...
                      <div className="carousel-inner" role="listbox">
                        ...
                        <div className="item active">
                          <div className="row">
                            <div className="carousel-caption">
                            <div className="container-fluid">                            
                                 <div className="carousel-profile col-lg-2 col-lg-offset-2 col-md-3 col-md-offset-1">
                                    <div className="col_image_container">
                                        <img className="prof_image" src="public/img/landing/testimonial_image.png"></img>
                                    </div>
                                 </div>
                                 <div className="carousel-text col-lg-6 col-md-6">
